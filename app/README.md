...
- **Two charts**: "By Top-Level Category" groups spending under its parent group (e.g. how much went to Expense vs. Savings); "By Category" breaks it down to the individual category, same idea as the top-level chart but at full granularity.
