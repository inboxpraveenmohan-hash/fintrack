...
- **Transfers**: a separate section (below Accounts) for moving money between two of your own accounts — not income or spending, so excluded from the stat cards and charts. E.g. paying a credit card bill is a transfer from SAVINGS to CC, which correctly reduces both the SAVINGS balance and the CC amount owed at once.
