...
- **Budget vs Actual**: set a recurring monthly budget per category (applies to every month until you change it) — a progress bar shows spend as a % of budget, turning red past 100%. Only categories with a budget set or actual spend this month are listed.
